...
@section('main-content')
    ...
    <div class="col-xs-12">
      <div class="box box-warning">
        <div class="box-header with-border">
          ...
          <a href="{{route('profile.edit')}}" class="btn btn-info pull-right">Edit</a>
          <a href="{{url('/change_password')}}" class="btn btn-info pull-right" style="margin-right :10px;">Change Password</a>
        </div>
        <!-- /.box-header -->
      </div>        
    </div>
    ...
    <div class="box box-widget widget-user">
      ...
      <div class="box-footer">
        ...
        <div class="col-sm-6">
            @if(Auth::user()->hasAnyRole(['student']) ==true )
